...
//ham truyen vao thread_foreach de tim kiem tien trinh dua vao tid
static void find_tid (struct thread *t, void * aux);

//tien trinh dang tim kiem trong danh sach
static struct thread * matching_thread;

//tid cua tien trinh dang tim kiem trong danh sach
...
{
//con tro luu tru tien trinh con
  struct thread *child_thread = NULL;

//con tro duyet qua danh sach tien trinh con
  struct list_elem *temp;

//neu danh sach tien trinh con rong, khong can cho
...
//neu tien trinh con chua duoc thiet lap
  if(child_thread == NULL)
    return -1;

//go bo tien trinh con khoi danh sach de tranh viec cho doi lan 2
  list_remove(&child_thread->child_elem);
  
//chuyen tien trinh cha ve trang thai sleep cho den khi tien trinh con ket thuc
  sema_down(&child_thread->being_waited_on);
  
//tra ve trang thai thoat cua tien trinh con
